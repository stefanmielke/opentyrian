...
typedef struct {
  ...
  bool direction[4], direction_pressed[4]; // up, right, down, left  (_pressed,
                                           // for emulating key presses)

  bool confirm, cancel;
  bool action[6],
      action_pressed[6]; // fire, mode swap, left fire, right fire, menu, pause
...
bool joystick_assignment_cmp(const Joystick_assignment *,
                             const Joystick_assignment *);
